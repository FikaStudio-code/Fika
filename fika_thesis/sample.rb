...
op.assignip("r1", epaira, "172.16.1.1", "255.255.255.0")
op.up("r1", epaira)
...
op.assignip("r1", epaira, "172.16.1.2", "255.255.255.0")
op.up("r1", epaira)
...
op.assignip("r1", epaira, "172.16.1.3", "255.255.255.0")
op.up("r1", epaira)
...
op.up("n5", epaira)
op.up("bridge2", epairb)
op.assigngw("n5", "192.168.2.101")

epaira, epairb = op.createpair
op.connect("r2", epaira)
op.connect("bridge2", epairb)
op.assignip("r2", epaira, "192.168.2.101", "255.255.255.0", "65002")
op.up("r2", epaira)
op.up("bridge2", epairb)
...
op.connect("r2", epaira)
op.connect("bridge001", epairb)
op.assignip("r2", epaira, "172.16.1.2", "255.255.255.0")
op.up("r2", epaira)
op.up("bridge001", epairb)
...
op.assignip("r2", epaira, "172.16.4.1", "255.255.0.0")
op.up("r2", epaira)
...
op.assignip("r2", epaira, "172.16.5.1", "255.255.255.0")
op.up("r2", epaira)
...
op.connect("r3", epaira)
op.connect("bridge003", epairb)
op.assignip("r3", epaira, "172.16.3.2", "255.255.255.0")
op.up("r3", epaira)
op.up("bridge003", epairb)
...
op.assignip("r3", epaira, "172.16.6.1", "255.255.255.0")
op.up("r3", epaira)
...
op.connect("bridge002", epairb)
op.assignip("r4", epaira, "172.16.2.2", "255.255.255.0")
op.up("r4", epaira)
op.up("bridge002", epairb)
...
op.connect("r4", epaira)
op.connect("bridge004", epairb)
op.assignip("r4", epaira, "172.16.4.2", "255.255.255.0")
op.up("r4", epaira)
op.up("bridge004", epairb)
...
op.assignip("r4", epaira, "172.16.7.1", "255.255.255.0")
op.up("r4", epaira)
...
op.assignip("r4", epaira, "172.16.8.1", "255.255.255.0")
op.up("r4", epaira)
...
op.assignip("r4", epaira, "172.16.9.1", "255.255.255.0")
op.up("r4", epaira)
...
op.connect("bridge005", epairb)
op.assignip("r5", epaira, "172.16.5.2", "255.255.255.0")
op.up("r5", epaira)
op.up("bridge005", epairb)
...
op.assignip("r5", epaira, "172.16.10.1", "255.255.255.0")
op.up("r5", epaira)
...
op.connect("r6", epaira)
op.connect("bridge006", epairb)
op.assignip("r6", epaira, "172.16.6.2", "255.255.255.0")
op.up("r6", epaira)
op.up("bridge006", epairb)
...
op.connect("r6", epaira)
op.connect("bridge007", epairb)
op.assignip("r6", epaira, "172.16.7.2", "255.255.255.0")
op.up("r6", epaira)
op.up("bridge007", epairb)
######################################
...
op.up("n9", epaira)
op.up("bridge4", epairb)
op.assigngw("n9", "192.168.7.101")

epaira, epairb = op.createpair
op.connect("r7", epaira)
op.connect("bridge4", epairb)
op.assignip("r7", epaira, "192.168.7.101", "255.255.255.0")
op.up("r7", epaira)
op.up("bridge4", epairb)
...
op.connect("r7", epaira)
op.connect("bridge008", epairb)
op.assignip("r7", epaira, "172.16.8.2", "255.255.255.0")
op.up("r7", epaira)
op.up("bridge008", epairb)
...
op.assignip("r7", epaira, "172.16.11.1", "255.255.255.0")
op.up("r7", epaira)
...
op.assigngw("n10", "192.168.8.101")

epaira, epairb = op.createpair
op.connect("r8", epaira)
op.connect("bridge5", epairb)
op.assignip("r8", epaira, "192.168.8.101", "255.255.255.0")
op.up("r8", epaira)
op.up("bridge5", epairb)
...
op.connect("r8", epaira)
op.connect("bridge009", epairb)
op.assignip("r8", epaira, "172.16.9.2", "255.255.255.0")
op.up("r8", epaira)
op.up("bridge009", epairb)
...
op.connect("r8", epaira)
op.connect("bridge010", epairb)
op.assignip("r8", epaira, "172.16.10.2", "255.255.255.0")
op.up("r8", epaira)
op.up("bridge010", epairb)
...
op.connect("r8", epaira)
op.connect("bridge011", epairb)
op.assignip("r8", epaira, "172.16.11.2", "255.255.255.0")
op.up("r8", epaira)
op.up("bridge011", epairb)
######################################
